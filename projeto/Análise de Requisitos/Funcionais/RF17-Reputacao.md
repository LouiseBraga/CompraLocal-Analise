O sistema deve permitir manter um mecanismo de reputação para lojistas e entregadores, baseado nas avaliações realizadas pelos usuários após a conclusão de pedidos.
